...
<main id="main">
    ...
    <section class="section">
      ...
      <div class="row mb-5">
        <?php
        $data = mysqli_query($koneksi, "SELECT * FROM tb_berita, tb_admin, tb_kategori WHERE tb_berita.id_admin=tb_admin.id_admin AND tb_berita.id_kategori=tb_kategori.id_kategori ORDER BY tb_berita.id_berita desc"); 
        ...
        <div class="col-md-4">
          ...
          <div class="post-text">
            <span class="post-meta"><?= $row['tgl_posting'];?> &bullet; By <?= $row['nama_lengkap']?> &bullet; <?= $row['kategori']?></span>
