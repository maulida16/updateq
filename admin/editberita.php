<?php 
    ...
    if(isset($_POST['submit'])){
        if($judul == ""){
            ...
            if(empty($foto)){ //kalau foto tidak diganti
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Edit Berita</h1>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row mb-5 align-items-end">
          <div class="col-md-6" data-aos="fade-up">
            ...
            <h2>UpdateQ</h2>
            <p class="mb-0">Silakan edit berita Anda</p>
          </div>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <input type="text" name="judul" class="form-control" placeholder="Masukkan Judul" class="input" value="<?=$b['judul'];?>">
                  <?= $judul_error;?>
                </div>
                ...
                <div class="col-md-12 form-group">
                  ...
                  <textarea class="form-control" name="isi" cols="30" rows="10" data-rule="required" placeholder="Isi Berita"><?=$b['text_berita'];?></textarea>
                  <?= $isi_error;?>
                </div>
                <div class="col-md-8">
